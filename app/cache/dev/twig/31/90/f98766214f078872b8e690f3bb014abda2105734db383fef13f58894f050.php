...
/* Admingenerated/InvisionSoporteBundle/Resources/views/TipoSedeList/row.html.twig */
class __TwigTemplate_3190f98766214f078872b8e690f3bb014abda2105734db383fef13f58894f050 extends Twig_Template
{
...
";
    ...
    {
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["TipoSede"]) ? $context["TipoSede"] : $this->getContext($context, "TipoSede")), "nombre"), "html", null, true);
    }
    ...
    ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("editar_tipo_sede", array("pk" => $this->getAttribute((isset($context["TipoSede"]) ? $context["TipoSede"] : $this->getContext($context, "TipoSede")), "Id"))), "html", null, true);
        echo "\"
        data-original-title=\"";
        // line 16
    ...
    ";
        ...
        // line 26
        echo "    <a  class=\"btn btn-default btn-xs \" href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("eliminar_tipo_sede", array("pk" => $this->getAttribute((isset($context["TipoSede"]) ? $context["TipoSede"] : $this->getContext($context, "TipoSede")), "Id"), "action" => "delete")), "html", null, true);
        echo "\"
        data-original-title=\"";
        // line 27
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('admingenerator_csrf')->getCsrfToken($this->env->getExtension('routing')->getPath("eliminar_tipo_sede", array("pk" => $this->getAttribute((isset($context["TipoSede"]) ? $context["TipoSede"] : $this->getContext($context, "TipoSede")), "Id"), "action" => "delete"))), "html", null, true);
    ...
    {
        return "Admingenerated/InvisionSoporteBundle/Resources/views/TipoSedeList/row.html.twig";
    }

...
/* Admingenerated/InvisionSoporteBundle/Resources/views/TipoSedeList/results.html.twig */
class __TwigTemplate_f4a073c1632d123cebc834dd165aec777fccc83916f565a217b679b811786869 extends Twig_Template
{
...
";
    ...
    ";
        // line 4
        $context["count"] = $this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "nbResults");
        // line 5
        echo "    ";
        $context["start"] = ((($this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "currentPage") - 1) * $this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "maxPerPage")) + 1);
        // line 6
        echo "    ";
        $context["end"] = (((isset($context["start"]) ? $context["start"] : $this->getContext($context, "start")) + $this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "maxPerPage")) - 1);
        // line 7
        echo "    ";
    ...
    ";
        // line 9
        if ($this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "haveToPaginate")) {
            // line 10
            echo "    ";
...
";
    ...
    public function block_list_tbody($context, array $blocks = array())
    {
        ...
        ";
        // line 52
        if ((twig_length_filter($this->env, (isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes"))) > 0)) {
            // line 53
            echo "
        ";
            // line 54
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["TipoSede"]) {
                // line 55
                echo "            ";
                $this->env->loadTemplate("InvisionSoporteBundle:TipoSedeList:row.html.twig")->display(array_merge($context, array()));
                // line 56
                echo "        ";
                ++$context['loop']['index0'];
                ++$context['loop']['index'];
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['TipoSede'], $context['_parent'], $context['loop']);
...
";
    ...
    public function block_generic_action_nuevo($context, array $blocks = array())
    {
        ...
        // line 83
        echo $this->env->getExtension('routing')->getPath("nuevo_tipo_sede", array());
...
";
    ...
    public function block_list_paginator_perpage($context, array $blocks = array())
    {
        // line 104
        echo "    ";
        if (($this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "haveToPaginate") || (!($this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "maxPerPage") === 10)))) {
            // line 105
        ...
        <button type=\"button\" class=\"btn btn-sm btn-default dropdown-toggle\" data-toggle=\"dropdown\">
            ";
            // line 108
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("pagerfanta.num.elements", array("%number%" => $this->getAttribute((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "maxPerPage")), "Admingenerator"), "html", null, true);
        ...
        <ul class=\"dropdown-menu pull-right\" role=\"menu\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["perPage"]) {
                ...
                <a href=\"";
                // line 113
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("Invision_SoporteBundle_TipoSede_list", array("perPage" => (isset($context["perPage"]) ? $context["perPage"] : $this->getContext($context, "perPage")))), "html", null, true);
                echo "\">
                    ";
                // line 114
    ...
    public function block_list_paginator_pages($context, array $blocks = array())
    {
        // line 125
        echo "        ";
        echo $this->env->getExtension('pagerfanta')->renderPagerfanta((isset($context["TipoSedes"]) ? $context["TipoSedes"] : $this->getContext($context, "TipoSedes")), "admingenerator");
        echo "
    ";
    }
    ...
    {
        return "Admingenerated/InvisionSoporteBundle/Resources/views/TipoSedeList/results.html.twig";
    }

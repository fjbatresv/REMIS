...
use Invision\SoporteBundle\Form\Type\Sede\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionSoporteBundle:SedeList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'Sedes' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\SedeList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\SedeList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\SedeList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\SoporteBundle\SedeList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\SoporteBundle\SedeList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\SedeList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\SedeList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\SedeList\Scopes', $this->getDefaultScopes());
    }

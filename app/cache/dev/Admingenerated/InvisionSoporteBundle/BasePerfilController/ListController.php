...
use Invision\SoporteBundle\Form\Type\Perfil\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionSoporteBundle:PerfilList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'Perfils' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\PerfilList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\PerfilList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\PerfilList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\SoporteBundle\PerfilList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\SoporteBundle\PerfilList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\PerfilList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\PerfilList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\PerfilList\Scopes', $this->getDefaultScopes());
    }

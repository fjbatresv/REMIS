...
class FiltersType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formOptions = $this->getFormOption('nombre', array(  'required' => false,  'label' => 'Usuario',  'translation_domain' => 'Admin',));
        ...
        $formOptions = $this->getFormOption('perfil_id', array(  'required' => false,  'label' => 'Perfil id',  'translation_domain' => 'Admin',));
        ...
        $formOptions = $this->getFormOption('password', array(  'required' => false,  'label' => 'Password',  'translation_domain' => 'Admin',));
        ...
        $formOptions = $this->getFormOption('sede_id', array(  'required' => false,  'label' => 'Sede id',  'translation_domain' => 'Admin',));

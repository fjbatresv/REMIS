...
use Invision\InventarioBundle\Form\Type\Color\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionInventarioBundle:ColorList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'Colors' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ColorList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ColorList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ColorList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\InventarioBundle\ColorList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\InventarioBundle\ColorList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ColorList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ColorList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ColorList\Scopes', $this->getDefaultScopes());
    }

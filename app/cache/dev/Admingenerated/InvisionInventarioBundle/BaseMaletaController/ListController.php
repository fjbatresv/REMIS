...
use Invision\InventarioBundle\Form\Type\Maleta\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionInventarioBundle:MaletaList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'Maletas' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaletaList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaletaList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaletaList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\InventarioBundle\MaletaList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\InventarioBundle\MaletaList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaletaList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaletaList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaletaList\Scopes', $this->getDefaultScopes());
    }

...
use Invision\InventarioBundle\Form\Type\Material\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionInventarioBundle:MaterialList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaterialList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaterialList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaterialList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\InventarioBundle\MaterialList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\InventarioBundle\MaterialList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaterialList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\MaterialList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\MaterialList\Scopes', $this->getDefaultScopes());
    }

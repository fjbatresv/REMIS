...
use Invision\InventarioBundle\Form\Type\ProcesoExtra\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionInventarioBundle:ProcesoExtraList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'ProcesoExtras' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\ProcesoExtraList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\ProcesoExtraList\Scopes', $this->getDefaultScopes());
    }

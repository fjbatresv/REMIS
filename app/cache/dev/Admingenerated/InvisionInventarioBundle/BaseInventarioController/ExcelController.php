...
class ExcelController extends ListController
{
    ...
    public function excelAction()
    {
      ...
      $response->headers->set('Content-Disposition', 'attachment;filename=admin_export_lista_de_articulos.xlsx');
    ...
    protected function createExcelheader(\PhpExcel_Worksheet $sheet){
        ...
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(1, 1, "Codigo", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(1);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(2, 1, "Color id", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(2);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(3, 1, "Cantidad", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(3);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(4, 1, "Costo", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(4);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(5, 1, "Venta", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(5);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(6, 1, "Descripcion", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(6);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(7, 1, "Imagen", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(7);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(8, 1, "Sede id", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(8);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(9, 1, "Created by", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(9);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(10, 1, "Updated by", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(10);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(11, 1, "Created at", true);
        $columnLetter = \PHPExcel_Cell::stringFromColumnIndex(11);
        $sheet->getStyle($columnLetter . '1')->getFont()->setBold(true);
        $sheet->getColumnDimension($columnLetter)->setAutoSize(true);
                      $sheet->setCellValueByColumnAndRow(12, 1, "Updated at", true);

...
use Invision\InventarioBundle\Form\Type\Inventario\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionInventarioBundle:InventarioList:index.html.twig', $this->getAdditionalRenderParameters() + array(
            'Inventarios' => $this->getPager(),
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\InventarioList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\InventarioList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\InventarioList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\InventarioBundle\InventarioList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\InventarioBundle\InventarioList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\InventarioList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\InventarioBundle\InventarioList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\InventarioBundle\InventarioList\Scopes', $this->getDefaultScopes());
    }

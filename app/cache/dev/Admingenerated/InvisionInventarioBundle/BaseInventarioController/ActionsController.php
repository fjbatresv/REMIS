...
$this->isCsrfTokenValid($intention);
        ...
        return $this->render(
            'InvisionInventarioBundle:InventarioActions:index.html.twig',
            $this->getAdditionalRenderParameters($Inventario, 'delete') + array(
                ...
                "actionRoute" => "Invision_InventarioBundle_Inventario_object",
    ...
    protected function executeObjectDelete(\Invision\InventarioBundle\Model\Inventario $Inventario)
    {
        $Inventario->delete();
    }
     ...
     */
    protected function successObjectDelete(\Invision\InventarioBundle\Model\Inventario $Inventario)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \Invision\InventarioBundle\Model\Inventario $Inventario = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \Invision\InventarioBundle\Model\Inventario primary keys
     *
     * To customize your action look into:
...
$intention = 'Invision_InventarioBundle_Inventario_batch';
$this->isCsrfTokenValid($intention);
    ...
    {
        \Invision\InventarioBundle\Model\InventarioQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Inventario) {
            throw new \InvalidArgumentException("No Invision\InventarioBundle\Model\Inventario found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\Invision\InventarioBundle\Model\Inventario $Inventario, $action)
    {
        return array();
    }

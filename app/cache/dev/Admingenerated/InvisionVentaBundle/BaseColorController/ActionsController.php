...
$this->isCsrfTokenValid($intention);
        ...
        return $this->render(
            'InvisionVentaBundle:ColorActions:index.html.twig',
            $this->getAdditionalRenderParameters($Color, 'delete') + array(
                ...
                "actionRoute" => "Invision_VentaBundle_Color_object",
    ...
    protected function executeObjectDelete(\Invision\SoporteBundle\Model\Color $Color)
    {
        $Color->delete();
    }
     ...
     */
    protected function successObjectDelete(\Invision\SoporteBundle\Model\Color $Color)
    {
        $this->get('session')->getFlashBag()->add(
            'success',
            $this->get('translator')->trans(
     ...
     * @return Response Must return a response!
     */
    protected function errorObjectDelete(\Exception $e, \Invision\SoporteBundle\Model\Color $Color = null)
    {
        $this->get('session')->getFlashBag()->add(
            'error',
            $this->get('translator')->trans(
     ...
     * checking CSRF protection token or credentials.
     *
     * @param array $selected Selected \Invision\SoporteBundle\Model\Color primary keys
     *
     * To customize your action look into:
...
$intention = 'Invision_VentaBundle_Color_batch';
$this->isCsrfTokenValid($intention);
    ...
    {
        \Invision\SoporteBundle\Model\ColorQuery::create()
    ...
    protected function getObject($pk)
    {
        ...
        if (!$Color) {
            throw new \InvalidArgumentException("No Invision\SoporteBundle\Model\Color found on Id : $pk");
        }
     ...
     */
    protected function getAdditionalRenderParameters(\Invision\SoporteBundle\Model\Color $Color, $action)
    {
        return array();
    }

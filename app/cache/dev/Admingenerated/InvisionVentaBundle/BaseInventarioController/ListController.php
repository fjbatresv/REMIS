...
use Invision\VentaBundle\Form\Type\Inventario\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionVentaBundle:InventarioList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\InventarioList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\InventarioList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\InventarioList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\VentaBundle\InventarioList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\VentaBundle\InventarioList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\InventarioList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\InventarioList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\InventarioList\Scopes', $this->getDefaultScopes());
    }

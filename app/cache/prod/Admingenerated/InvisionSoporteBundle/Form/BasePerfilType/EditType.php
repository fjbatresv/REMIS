...
namespace Admingenerated\InvisionSoporteBundle\Form\BasePerfilType;
...
class EditType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $formOptions = $this->getFormOption('descripcion', array(  'required' => true,  'label' => 'Descripcion',  'translation_domain' => 'Admin',));

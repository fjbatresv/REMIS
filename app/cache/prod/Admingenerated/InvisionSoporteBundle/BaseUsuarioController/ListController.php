...
use Invision\SoporteBundle\Form\Type\Usuario\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionSoporteBundle:UsuarioList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\UsuarioList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\UsuarioList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\UsuarioList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\SoporteBundle\UsuarioList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\SoporteBundle\UsuarioList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\UsuarioList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\SoporteBundle\UsuarioList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\SoporteBundle\UsuarioList\Scopes', $this->getDefaultScopes());
    }

...
use Invision\VentaBundle\Form\Type\Color\FiltersType;
...
class ListController extends BaseController
{
    public function indexAction()
    {
        ...
        return $this->render('InvisionVentaBundle:ColorList:index.html.twig', $this->getAdditionalRenderParameters() + array(
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\ColorList\Page', $page);
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\Page', 1);
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\ColorList\PerPage', $perPage);
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\PerPage', 10);
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\ColorList\Sort', $column);

        if ($order_by == 'desc') {
            $this->get('session')->set('Invision\VentaBundle\ColorList\OrderBy', 'DESC');
        } else {
             $this->get('session')->set('Invision\VentaBundle\ColorList\OrderBy', 'ASC');
        }
    }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\Sort');
        }
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\OrderBy', 'ASC');
        }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\ColorList\Filters', $filters);
    }
    
    protected function getFilters()
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\Filters', array());
    }
    ...
    {
        $this->get('session')->set('Invision\VentaBundle\ColorList\Scopes', $scopes);
    }
    ...
    */
    ...
    {
        return $this->get('session')->get('Invision\VentaBundle\ColorList\Scopes', $this->getDefaultScopes());
    }

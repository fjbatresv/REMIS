...
abstract class BaseColor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Invision\\InventarioBundle\\Model\\ColorPeer';
     ...
     * @return Color The current object (for fluent API support)
     */
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = ColorPeer::NOMBRE;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = ColorPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = ColorPeer::UPDATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ColorPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ColorPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = ColorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Color object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ColorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ColorPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ColorPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ColorPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ColorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ColorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ColorPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`nombre`';
        }
        if ($this->isColumnModified(ColorPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`created_by`';
        }
        if ($this->isColumnModified(ColorPeer::UPDATED_BY)) {
    ...
    {
        $pos = ColorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Color'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Color'][$this->getPrimaryKey()] = true;
        $keys = ColorPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ColorPeer::ID)) $criteria->add(ColorPeer::ID, $this->id);
        if ($this->isColumnModified(ColorPeer::NOMBRE)) $criteria->add(ColorPeer::NOMBRE, $this->nombre);
        if ($this->isColumnModified(ColorPeer::CREATED_BY)) $criteria->add(ColorPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(ColorPeer::UPDATED_BY)) $criteria->add(ColorPeer::UPDATED_BY, $this->updated_by);
        if ($this->isColumnModified(ColorPeer::CREATED_AT)) $criteria->add(ColorPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ColorPeer::UPDATED_AT)) $criteria->add(ColorPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(ColorPeer::DATABASE_NAME);
        $criteria->add(ColorPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Color (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Color Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Color is new, it will return
    ...
    public function setInventarios(PropelCollection $inventarios, PropelPDO $con = null)
    {
        ...
        foreach ($inventariosToDelete as $inventarioRemoved) {
            $inventarioRemoved->setColor(null);
        }
     ...
     * Otherwise if this Color is new, it will return
     * an empty collection; or if this Color has previously
     * been saved, it will retrieve related Inventarios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Color.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Inventario[] List of Inventario objects
     */
    public function getInventariosJoinSede($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = InventarioQuery::create(null, $criteria);
        $query->joinWith('Sede', $join_behavior);
    ...
    {
        return (string) $this->exportTo(ColorPeer::DEFAULT_STRING_FORMAT);
    }

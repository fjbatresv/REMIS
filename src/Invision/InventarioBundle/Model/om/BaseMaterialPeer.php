...
use Invision\InventarioBundle\Model\map\MaterialTableMap;
...
abstract class BaseMaterialPeer
{
    ...
    const OM_CLASS = 'Invision\\InventarioBundle\\Model\\Material';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Invision\\InventarioBundle\\Model\\map\\MaterialTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Material objects.
     ...
     * e.g. MaterialPeer::$fieldNames[MaterialPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (MaterialPeer::ID, MaterialPeer::NOMBRE, MaterialPeer::DESCRIPCION, MaterialPeer::COSTO, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. MaterialPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (MaterialPeer::ID => 0, MaterialPeer::NOMBRE => 1, MaterialPeer::DESCRIPCION => 2, MaterialPeer::COSTO => 3, ),
    ...
    {
        $toNames = MaterialPeer::getFieldNames($toType);
        $key = isset(MaterialPeer::$fieldKeys[$fromType][$name]) ? MaterialPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(MaterialPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, MaterialPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return MaterialPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MaterialPeer::COSTO);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MaterialPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(MaterialPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            MaterialPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(MaterialPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(MaterialPeer::$instances[$key])) {
                return MaterialPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (MaterialPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        MaterialPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(MaterialPeer::DATABASE_NAME)->getTable(MaterialPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMaterialPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Invision\InventarioBundle\Model\map\MaterialTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(MaterialPeer::ID) && $criteria->keyContainsValue(MaterialPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(MaterialPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(MaterialPeer::ID);
            $value = $criteria->remove(MaterialPeer::ID);
            if ($value) {
                $selectCriteria->add(MaterialPeer::ID, $value, $comparison);
            } else {

...
use Invision\InventarioBundle\Model\map\ColorTableMap;
...
abstract class BaseColorPeer
{
    ...
    const OM_CLASS = 'Invision\\InventarioBundle\\Model\\Color';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Invision\\InventarioBundle\\Model\\map\\ColorTableMap';
    ...
    const CREATED_BY = 'color.created_by';

    /** the column name for the updated_by field */
    const UPDATED_BY = 'color.updated_by';

    /** the column name for the created_at field */
    const CREATED_AT = 'color.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'color.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nombre', 'CreatedBy', 'UpdatedBy', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (ColorPeer::ID, ColorPeer::NOMBRE, ColorPeer::CREATED_BY, ColorPeer::UPDATED_BY, ColorPeer::CREATED_AT, ColorPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE', 'CREATED_BY', 'UPDATED_BY', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'created_by', 'updated_by', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nombre' => 1, 'CreatedBy' => 2, 'UpdatedBy' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'createdBy' => 2, 'updatedBy' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (ColorPeer::ID => 0, ColorPeer::NOMBRE => 1, ColorPeer::CREATED_BY => 2, ColorPeer::UPDATED_BY => 3, ColorPeer::CREATED_AT => 4, ColorPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE' => 1, 'CREATED_BY' => 2, 'UPDATED_BY' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'created_by' => 2, 'updated_by' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ColorPeer::NOMBRE);
            $criteria->addSelectColumn(ColorPeer::CREATED_BY);
            $criteria->addSelectColumn(ColorPeer::UPDATED_BY);
            $criteria->addSelectColumn(ColorPeer::CREATED_AT);
            $criteria->addSelectColumn(ColorPeer::UPDATED_AT);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseColorPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Invision\InventarioBundle\Model\map\ColorTableMap());
      }
    }

...
use Invision\SoporteBundle\Model\map\PerfilTableMap;
...
abstract class BasePerfilPeer
{
    ...
    const OM_CLASS = 'Invision\\SoporteBundle\\Model\\Perfil';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Invision\\SoporteBundle\\Model\\map\\PerfilTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePerfilPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Invision\SoporteBundle\Model\map\PerfilTableMap());
      }
    }

...
abstract class BasePerfilMenu extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Invision\\SoporteBundle\\Model\\PerfilMenuPeer';
     ...
     * @return PerfilMenu The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PerfilMenuPeer::ID;
        }
    ...
    public function setPerfilId($v)
    {
        ...
        if ($this->perfil_id !== $v) {
            $this->perfil_id = $v;
            $this->modifiedColumns[] = PerfilMenuPeer::PERFIL_ID;
        }
    ...
    public function setMenuId($v)
    {
        ...
        if ($this->menu_id !== $v) {
            $this->menu_id = $v;
            $this->modifiedColumns[] = PerfilMenuPeer::MENU_ID;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = PerfilMenuPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = PerfilMenuPeer::UPDATED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PerfilMenuPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PerfilMenuPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = PerfilMenuPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PerfilMenu object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PerfilMenuPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PerfilMenuQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PerfilMenuPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PerfilMenuPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PerfilMenuPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PerfilMenuPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PerfilMenuPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PerfilMenuPeer::PERFIL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`perfil_id`';
        }
        if ($this->isColumnModified(PerfilMenuPeer::MENU_ID)) {
            $modifiedColumns[':p' . $index++]  = '`menu_id`';
        }
        if ($this->isColumnModified(PerfilMenuPeer::CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = '`created_by`';
        }
        if ($this->isColumnModified(PerfilMenuPeer::UPDATED_BY)) {
        ...
        $sql = sprintf(
            'INSERT INTO `perfil_menu` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PerfilMenuPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PerfilMenuPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PerfilMenu'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PerfilMenu'][$this->getPrimaryKey()] = true;
        $keys = PerfilMenuPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PerfilMenuPeer::ID)) $criteria->add(PerfilMenuPeer::ID, $this->id);
        if ($this->isColumnModified(PerfilMenuPeer::PERFIL_ID)) $criteria->add(PerfilMenuPeer::PERFIL_ID, $this->perfil_id);
        if ($this->isColumnModified(PerfilMenuPeer::MENU_ID)) $criteria->add(PerfilMenuPeer::MENU_ID, $this->menu_id);
        if ($this->isColumnModified(PerfilMenuPeer::CREATED_BY)) $criteria->add(PerfilMenuPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(PerfilMenuPeer::UPDATED_BY)) $criteria->add(PerfilMenuPeer::UPDATED_BY, $this->updated_by);
        if ($this->isColumnModified(PerfilMenuPeer::CREATED_AT)) $criteria->add(PerfilMenuPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PerfilMenuPeer::UPDATED_AT)) $criteria->add(PerfilMenuPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PerfilMenuPeer::DATABASE_NAME);
        $criteria->add(PerfilMenuPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PerfilMenu (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PerfilMenu Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PerfilMenuPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PerfilMenuPeer();
        }
    ...
    public function getPerfil(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPerfil === null && ($this->perfil_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPerfil->addPerfilMenus($this);
             */
        }
    ...
    {
        if ($this->aMenu === null && ($this->menu_id !== null) && $doQuery) {
    ...
    {
        return (string) $this->exportTo(PerfilMenuPeer::DEFAULT_STRING_FORMAT);
    }

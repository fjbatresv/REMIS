...
abstract class BaseHorario extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Invision\\SoporteBundle\\Model\\HorarioPeer';
    ...
    /**
     * The value for the dia_id field.
     * @var        int
     */
    protected $dia_id;
     ...
     */
    public function getHoraInicio($format = null)
    {
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getHoraFin($format = null)
    {
     ...
     * @return Horario The current object (for fluent API support)
     */
    ...
    /**
     * Set the value of [dia_id] column.
     *
     * @param  int $v new value
     * @return Horario The current object (for fluent API support)
     */
    public function setDiaId($v)
    {
        ...
        if ($this->dia_id !== $v) {
            $this->dia_id = $v;
            $this->modifiedColumns[] = HorarioPeer::DIA_ID;
        }
    ...
    public function setHoraInicio($v)
    {
        ...
        if ($this->hora_inicio !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HorarioPeer::HORA_INICIO;
            }
    ...
    public function setHoraFin($v)
    {
        ...
        if ($this->hora_fin !== null || $dt !== null) {
            $currentDateAsString = ($this->hora_fin !== null && $tmpDt = new DateTime($this->hora_fin)) ? $tmpDt->format('H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->hora_fin = $newDateAsString;
                $this->modifiedColumns[] = HorarioPeer::HORA_FIN;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->dia_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = HorarioPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aDia !== null && $this->dia_id !== $this->aDia->getId()) {
            $this->aDia = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = HorarioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = HorarioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HorarioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aDia !== null) {
                if ($this->aDia->isModified() || $this->aDia->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HorarioPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(HorarioPeer::DIA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`dia_id`';
        }
        if ($this->isColumnModified(HorarioPeer::HORA_INICIO)) {
            $modifiedColumns[':p' . $index++]  = '`hora_inicio`';
        }
        if ($this->isColumnModified(HorarioPeer::HORA_FIN)) {
            $modifiedColumns[':p' . $index++]  = '`hora_fin`';
        }

        $sql = sprintf(
            'INSERT INTO `horario` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`dia_id`':
                        $stmt->bindValue($identifier, $this->dia_id, PDO::PARAM_INT);
                        break;
                    case '`hora_inicio`':
    ...
    {
        if (isset($alreadyDumpedObjects['Horario'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Horario'][$this->getPrimaryKey()] = true;
        $keys = HorarioPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDiaId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aDia) {
                $result['Dia'] = $this->aDia->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDiaId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HorarioPeer::DIA_ID)) $criteria->add(HorarioPeer::DIA_ID, $this->dia_id);
        if ($this->isColumnModified(HorarioPeer::HORA_INICIO)) $criteria->add(HorarioPeer::HORA_INICIO, $this->hora_inicio);
        if ($this->isColumnModified(HorarioPeer::HORA_FIN)) $criteria->add(HorarioPeer::HORA_FIN, $this->hora_fin);
     ...
     * objects.
     *
     * @param object $copyObj An object of Horario (or compatible) type.
    ...
    {
        $copyObj->setDiaId($this->getDiaId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Horario Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a Dia object.
     *
     * @param                  Dia $v
     * @return Horario The current object (for fluent API support)
     * @throws PropelException
     */
    public function setDia(Dia $v = null)
    {
        if ($v === null) {
            $this->setDiaId(NULL);
        } else {
        ...
        // If this object has already been added to the Dia object, it will not be re-added.
        if ($v !== null) {
            $v->addHorario($this);
        }
    ...
    /**
     * Get the associated Dia object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Dia The associated Dia object.
     * @throws PropelException
     */
    public function getDia(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDia === null && ($this->dia_id !== null) && $doQuery) {
            $this->aDia = DiaQuery::create()->findPk($this->dia_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDia->addHorarios($this);
             */
        }
     ...
     * If this Horario is new, it will return
    ...
    public function setUsuarioHorarios(PropelCollection $usuarioHorarios, PropelPDO $con = null)
    {
        ...
        foreach ($usuarioHorariosToDelete as $usuarioHorarioRemoved) {
            $usuarioHorarioRemoved->setHorario(null);
        }
    ...
    protected function doAddUsuarioHorario($usuarioHorario)
    {
        ...
        $usuarioHorario->setHorario($this);
    }
    ...
    public function removeUsuarioHorario($usuarioHorario)
    {
        if ($this->getUsuarioHorarios()->contains($usuarioHorario)) {
            ...
            $usuarioHorario->setHorario(null);
        }
     ...
     * Otherwise if this Horario is new, it will return
     * an empty collection; or if this Horario has previously
     * been saved, it will retrieve related UsuarioHorarios from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Horario.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|UsuarioHorario[] List of UsuarioHorario objects
     */
    public function getUsuarioHorariosJoinUsuario($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UsuarioHorarioQuery::create(null, $criteria);
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aDia instanceof Persistent) {
              $this->aDia->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(HorarioPeer::DEFAULT_STRING_FORMAT);
    }

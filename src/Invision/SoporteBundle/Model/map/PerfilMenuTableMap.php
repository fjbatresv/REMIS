...
class PerfilMenuTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Invision.SoporteBundle.Model.map.PerfilMenuTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Invision\\SoporteBundle\\Model\\PerfilMenu');
    ...
    {
        $this->addRelation('Perfil', 'Invision\\SoporteBundle\\Model\\Perfil', RelationMap::MANY_TO_ONE, array('perfil_id' => 'id', ), 'CASCADE', 'CASCADE');
        $this->addRelation('Menu', 'Invision\\SoporteBundle\\Model\\Menu', RelationMap::MANY_TO_ONE, array('menu_id' => 'id', ), null, null);
    } // buildRelations()

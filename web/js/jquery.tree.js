...
(function ($, undefined) {
    $.widget("daredevel.tree", {
        ...
        _checkAncestors: function (li) {
            ...
            li.parentsUntil('daredevel-tree').filter('li').children('div').find('span:first').addClass('checked');
        },
        ...
        _checkDescendants: function (li) {
            ...
            li.find('li span').addClass('checked');
        },
...
//            li.find('li span').addClass('checked');
        ...
        _uncheckAncestors: function (li) {
            ...
            li.parentsUntil('daredevel-tree').filter('li').children('div').find('span:first').removeClass('checked');
        },
        ...
        _uncheckDescendants: function (li) {
            ...
            li.find('li span').removeClass('checked');
        },
